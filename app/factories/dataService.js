(function(){
    angular
        .module("turtleFacts")
        .factory("dataService", function(){ // name in factory is case sensitive! other module will
            var dataObj = {                 // refer the name in the factory declaration .
        ...
        var turtlesData = [
                    {
                        type: "Green Turtle",
                        image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Lepidochelys-olivacea-K%C3%A9lonia-1.JPG/220px-Lepidochelys-olivacea-K%C3%A9lonia-1.JPG",
